...
import { BiLike, BiDislike } from 'react-icons/bi';      // BoxIcons
import { MdPlaylistAdd } from 'react-icons/md';          // Material Design Icons
...
// Wrapper component to provide videoId from URL params to the Video component
const VideoWithParams = props => {
  const params = useParams()
  return <Video {...props} videoId={params.id} />
}

export default VideoWithParams
